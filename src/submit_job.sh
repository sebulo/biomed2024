...
python src/train_radiomicsxgb_outlier_detection.py -c src/outlier-challenge-config_gbar_dtu.json -d train_files.txt # custom_train_list_100.txt # train_files.txt
python src/validate_radiomicsxgb_outlier_detection.py -c src/outlier-challenge-config_gbar_dtu.json -d custom_validation_list_100.txt
python src/test_radiomicsxgb_outlier_detection.py -c src/outlier-challenge-config_gbar_dtu.json -d test_files_200.txt
